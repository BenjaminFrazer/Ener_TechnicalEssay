...
The key advantage of this scenario is of course the greater ease of storage[[cite:&HydrogenEnergyStorag2]]. As such demand can be assumed to be dis-patchable to a certain degree, as long as the correct net energy is delivered.
