...
Choosing the optimal energy strategy is not simply a case of electing the lowest LCOE since the LCOE itself will be a function of the capacity factor. This can be seen from Equation ref:eqLCOE since energy generated grows as a function of
