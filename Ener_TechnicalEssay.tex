...
\bottomrule
\end{tabular}
\end{sidewaystable}\footnotetext[16]{\label{org88c4e78}This name has been changed to from 'CCS cost' for compatibility with Table \ref{tabLCOEBreakdownGov2020}.}
